...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/UIDevice+DeviceModel"
  ...
  s.author             = { "袁斌" => "bin.yuan@baidao.com" }
  # Or just: s.author    = "袁斌"
  # s.authors            = { "袁斌" => "bin.yuan@baidao.com" }
  ...
  s.source       = { :git => "http://EXAMPLE/UIDevice+DeviceModel.git", :tag => "#{s.version}" }
